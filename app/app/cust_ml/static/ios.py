...
import json
import joblib
from app_utils import cal_add_feat
...
if __name__=="__main__":
    # 加载所需文件
    lgb_model=joblib.load('ios_newModel_0704.pkl')
    feat_cols=[i.strip() for i in open('ios_feat_0704.txt','r',encoding='utf8').readlines()]
    category_cols=[i.strip() for i in open('ios_cat_feat_0704.txt','r',encoding='utf8').readlines()]
    with open("mobile_brand_map_ios.json", 'r', encoding='utf-8') as fw:
    ...
    data = pd.read_csv('ios_1020220510213658000223916.csv')
